      ...
      children: <Widget>[
                ...
                return CustomButton(
                  onTap: () {
                    _client
                        ...
                        variables: {"latestVisibleId": _lastLatesFeedId}))
                        .then((onValue) {
                      for (var todo in onValue.data.data['todos'].reversed) {
                        feedList.addFeed(todo['id'].toString(), todo['title'],
                            todo['user']['name']);
                      }
                      _lastLatesFeedId = int.parse(feedList.list.first.id);
                      _newTodoCount = 0;
                      setState(() {});
                    }).catchError((e) {
                      print(e);
        ...
        CustomButton(
          onTap: () {
            ...
            _client.query(
              QueryOptions(document: FeedFetch.loadMoreTodos,
